    ...
    <SafeAreaView style={styles.container}>
      ...
      >
        ...
        <Text style={styles.paragraph}>
          By accessing or using the Dr. Dwar application (&quots;the
          App&quots;), you agree to be bound by these Terms and Conditions. If
          you do not agree to these terms, please do not use the App.
        </Text>

        <Text style={styles.sectionTitle}>2. Description of Service</Text>
        <Text style={styles.paragraph}>
          The Dr. Dwar App is a financial management tool that allows users to
          track their personal expenses, income, and manage their financial
          data. The App is provided on an &quots;as is&quots; and &quots;as
          available&quots; basis.
        </Text>
        ...
        <Text style={styles.paragraph}>
          The App collects and processes personal information as described in
          our Privacy Policy. By using the App, you consent to such processing
        ...
        <Text style={styles.paragraph}>
          ...
          the App operates, without regard to its conflict of law provisions.
        </Text>
        ...
        <Text style={styles.paragraph}>
          ...
          App. Your continued use of the App after such changes constitutes your
          ...
          <Text
            ...
            onPress={() => {
              ...
              import("react-native").then(({ Linking }) => {
                Linking.openURL(
                  `mailto:${process.env.EXPO_PUBLIC_EMAIL_ADDRESS}`,
                );
              });
            }}
          >
