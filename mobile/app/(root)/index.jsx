...
const mockNews = [
    {
        ...
        summary: "Government announces comprehensive health coverage for rural areas",
        date: "2025-09-11",
        category: "Health Policy",
        priority: "high",
        content: "The government has launched a new health insurance scheme providing coverage up to ₹5 lakhs for families in rural areas. This initiative aims to make healthcare more accessible and affordable.",
    ...
    },
    {
        ...
        priority: "medium",
        content: "All citizens above 60 years can get free COVID-19 booster shots at nearby health centers. No prior appointment required.",
    ...
    },
    {
        ...
        priority: "medium",
        content: "Mobile medical units will visit remote villages every Tuesday and Friday. Services include basic checkups, medicine distribution, and health awareness programs.",
    ...
    },
    {
        ...
        priority: "low",
        content: "Patients can now access their complete medical history through the new digital health portal. Registration is free and secure.",
    ...
    },
    {
        ...
        category: "Emergency",
        priority: "high",
        content: "Updated emergency contact numbers: Ambulance - 108, Medical Helpline - 104, COVID Helpline - 1075. Available 24/7.",
        author: "Emergency Services"
    }
]

const categories = ["All", "Pain Relief", "Antibiotic", "Vitamins", "Cardio", "Antacid"]
        ...
        <TouchableOpacity 
            ...
            onPress={() => Alert.alert(
                ...
                [
                    ...
                    { text: 'Add to Cart', onPress: () => Alert.alert('Added', `${item.name} added to cart!`) }
                ]
            )}
        >
            <View style={styles.medicineHeader}>
                <Text style={styles.medicineEmoji}>{item.image}</Text>
                <View style={[styles.stockBadge, { backgroundColor: item.inStock ? COLORS.income : COLORS.expense }]}>
        ...
        >
            <View style={styles.newsCardHeader}>
                <View style={[styles.priorityBadge, { 
                    backgroundColor: item.priority === 'high' ? COLORS.expense : 
                                   item.priority === 'medium' ? '#FF9500' : COLORS.textLight 
                }]}>
    ...
    const renderJansevaTab = () => (
        <View style={styles.tabContent}>
            <View style={styles.newsHeaderSection}>
                ...
                <Text style={styles.newsHeaderSubtitle}>Daily Health Updates & Announcements</Text>
            </View>
            ...
            <View style={[styles.content, { flex: 1, paddingBottom: 120 }]}>
                ...
                <View style={styles.tabContainer}>
                    ...
                    >
                        <View style={[
                            ...
                            <Ionicons 
                                name="medical" 
                                size={20} 
                                color={activeTab === 'pharmacy' ? COLORS.white : COLORS.textLight} 
                            />
                        </View>
                        <Text style={[
                            styles.tabText,
                    ...
                    <TouchableOpacity
                        style={[
                            styles.tab,
                            activeTab === 'janseva' && styles.activeTab
                        ]}
                    ...
                    >
                        <View style={[
                            ...
                            <Ionicons 
                                name="newspaper" 
                                size={20} 
                                color={activeTab === 'janseva' ? COLORS.white : COLORS.textLight} 
                            />
                        </View>
                        <Text style={[
                            styles.tabText,
