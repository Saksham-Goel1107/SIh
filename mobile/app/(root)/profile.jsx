...
export default function Profile() {
    ...
    const ProfileItem = ({ icon, title, subtitle, onPress, rightElement, showArrow = false }) => (
        <TouchableOpacity style={profileStyles.item} onPress={onPress}>
            <View style={profileStyles.itemLeft}>
                ...
                <View style={profileStyles.itemText}>
                    ...
                    {subtitle && <Text style={profileStyles.itemSubtitle}>{subtitle}</Text>}
                </View>
            </View>
        ...
        <View style={profileStyles.container}>
            ...
            >
                ...
                <View style={profileStyles.headerCard}>
                    <View style={profileStyles.avatarContainer}>
                        {user?.imageUrl ? (
                            ...
                            <View style={profileStyles.avatarPlaceholder}>
                                <Text style={profileStyles.avatarText}>{getUserInitials()}</Text>
                            </View>
                        )}
                        <TouchableOpacity style={profileStyles.editAvatarBtn} onPress={handleEditProfile}>
                    ...
                    <TouchableOpacity style={profileStyles.editBtn} onPress={handleEditProfile}>
                ...
                <ProfileSection title="Support">
                    ...
                    <ProfileItem
                        ...
                        onPress={() => Alert.alert('About', 'Health App v1.0.0\nBuilt with ❤️ for better health')}
                    />
                </ProfileSection>
